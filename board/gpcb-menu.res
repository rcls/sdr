...
#
  {"Info"
   ...
   {"Key Bindings"
    ...
    {"ChangeSize +1 mil" a={"S" "<Key>s"} ChangeSize(Object,+1,mil)}
    {"ChangeSize -1 mil" a={"Shift-S" "Shift<Key>s"} ChangeSize(Object,-1,mil)}
    {"ChangeDrill +1 mil" a={"Alt-S" "Alt<Key>s"} ChangeDrillSize(Object,+1,mil)}
    {"ChangeDrill -1 mil" a={"Alt-Shift-S" "Alt Shift<Key>s"} ChangeDrillSize(Object,-1,mil)}
